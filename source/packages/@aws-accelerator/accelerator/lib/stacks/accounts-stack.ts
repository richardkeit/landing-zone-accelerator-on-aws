...
export class AccountsStack extends AcceleratorStack {
  ...
  constructor(scope: Construct, id: string, props: AccountsStackProps) {
    ...
    if (props.globalRegion === cdk.Stack.of(this).region) {
      ...
      //
      const policyResource = new PolicyResource(
        this,
        this.keyResource.cloudwatchKey,
        this.keyResource.lambdaKey,
        props,
      );

      // Calling this method as it's called in both the Finalize and Accounts stack to
      // dynamically populate VPC IDs generated by the pipeline.
      const policyItems = policyResource.createAndAttachPolicies(props);
      ...
      //
      policyResource.configureAndAttachQuarantineScp(policyItems.scpItems, props);
