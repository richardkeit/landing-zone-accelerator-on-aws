...
| ImageUri | `public.ecr.aws/aws-solutions/landing-zone-accelerator-on-aws:v1.16.0-rc.6` | The Amazon Elastic Container Registry (Amazon ECR) repository, where Landing Zone Accelerator on AWS code is present. |
